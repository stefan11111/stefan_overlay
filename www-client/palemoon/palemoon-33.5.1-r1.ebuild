...
#Github is broken with the latest release
#The fix should come it 33.6.0
#In the meantime, just build a commit with the fix
#See:
#https://forum.palemoon.org/viewtopic.php?f=70&t=32021
#https://repo.palemoon.org/MoonchildProductions/UXP/issues/2681
#https://repo.palemoon.org/MoonchildProductions/UXP/issues/2682
#
#There is also a workaround with http response filters
#[["github.githubassets.com",["/ui_packages_ui-commands_ui-commands_ts/",["dialog:modal, ",""]]]]

EGIT_COMMIT="6e5337e45e942f2e314543893d6d3a068f06df63"
