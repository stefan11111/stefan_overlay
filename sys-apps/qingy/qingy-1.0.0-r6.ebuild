...
IUSE="crypt emacs gpm pam static X directfb"
...
DEPEND="
	...
	directfb? ( dev-libs/DirectFB[fbcon,png,jpeg,truetype] )
	X? (
		x11-libs/libX11:=
...
src_configure() {
    ...
    use !directfb && myeconfargs += "--disable-DirectFB-support"
