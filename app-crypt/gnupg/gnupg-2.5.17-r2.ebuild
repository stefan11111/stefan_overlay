...
IUSE="+alternatives bzip2 doc ldap nls readline selinux +smartcard gpgsm ssl gnutls ntbtls test +tofu tpm tools usb user-socket wks-server"
RESTRICT="!test? ( test )"
REQUIRED_USE="test? ( tofu ) ssl? ( ^^ ( gnutls ntbtls ) )"
...
DEPEND="
	...
	gnutls? ( >=net-libs/gnutls-3.2:0= )
	ntbtls? ( dev-libs/ntbtls:0= )
"
RDEPEND="
	${DEPEND}
	nls? ( virtual/libintl )
